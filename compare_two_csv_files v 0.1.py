# -*- coding: utf-8 -*-
"""
Created on Sun Jan  17 17:46:22 2021
...
Limitations:
    ...
    4. Only files in the parent dirtectory are considered
       i.e. files in the sub-folder or directory are not considered
    5. Measure file/column name should be 'Value' as it is hardcoded in the code in this version
